...
public class NpcShopWnd : ClosableWnd
{
	...
	protected override void Awake()
	{
		...
		if (!_Button_ShopItemPrefab)
		{
			_Button_ShopItemPrefab = ResourceManager.Instance.LoadResource<GameObject>(
				"_Button_ShopItem",
				"Prefabs/UI/Wnds/NpcShopWnd/Button_ShopItem").GetComponent<ShopItem>();
		}
		...
		if (!_Wnd_TradePrefab)
		{
			_Wnd_TradePrefab = ResourceManager.Instance.LoadResource<GameObject>(
				"Wnd_Trade",
				"Prefabs/UI/Wnds/TradeWnd/Wnd_Trade").GetComponent<TradeWnd>();
		}
	}
